...
// literally just a copy of javascript's syntax highlighting but with ducky keywords

CodeMirror.defineMode("ducky", function(config, parserConfig) {
  ...
  return {
    ...
    helperType: jsonMode ? "json" : "ducky",
...
CodeMirror.registerHelper("wordChars", "ducky", /[\w$]/);
CodeMirror.defineMIME("text/ducky", "ducky");
